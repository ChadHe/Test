...
sap.ui.core.mvc.Controller.extend("com.abeam.zccitsollib.view.Detail", {
	...
	onInit: function() {
		...
		var oJSON = new  sap.ui.model.json.JSONModel({
			lineItemListTitle: this.getOwnerComponent().getModel("i18n").getResourceBundle().getText("lineItemListTitle")
		});
		this.getView().setModel(oJSON,"detailView");
	},
	...
	onRouteMatched: function(oEvent) {
		...
		jQuery.when(this.oInitialLoadFinishedDeferred).then(jQuery.proxy(function() {
			...
			if (sTabKey == undefined){
				sTabKey=oIconTabBar.getItems()[0].getKey();
			}
	...
	onListUpdateFinished: function(oEvent) {
		...
		var tTitle=this.getOwnerComponent().getModel("i18n").getResourceBundle().getText("lineItemListTitle", [total]);
		this.getView().getModel("detailView").setProperty("/lineItemListTitle", tTitle);
	}
});